...
* @date 2023/01/15
*
* @details オリジナルシェーダーを使用した3Dモデルの描画基本1 （剛体メッシュのライティング無し描画）
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	// 頂点シェーダーを読み込む
	vertexShaderHandle = LoadVertexShader("Resource/NormalMesh_NoLightVS.vso");

	// ピクセルシェーダーを読み込む
	pixelShaderHandle = LoadPixelShader("Resource/NormalMesh_NoLightPS.pso");
